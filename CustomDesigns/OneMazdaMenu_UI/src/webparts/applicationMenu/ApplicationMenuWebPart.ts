...
export default class ApplicationMenuWebPart extends BaseClientSideWebPart<IApplicationMenuWebPartProps> {
  ...
  public render(): void {
    ...
    this.domElement.innerHTML = `<div class="customNav">
    <div class="appmenuContainer">
      <div>Applications<span class="appmenuArrow"></span></div>
      <ul class="approot" style="display: none;">
        <li><a id="lnkNameTag" href="#" description="NameTag System">NameTag System</a></li><li>          
        </li>                                       
      </ul>
    </div>
  </div>`
  ...
  protected onInit(): Promise<void> {
    ...
    SPComponentLoader.loadCss('https://mazdausa.sharepoint.com/sites/MCISPOTestSite/SiteAssets/Branding/css/styles/SuiteNav.css');
    SPComponentLoader.loadScript("https://mazdausa.sharepoint.com/sites/MCISPOTestSite/SiteAssets/Branding/js/jquery-1.10.2.min.js",{globalExportsName:'jquery'}).then(()=>{    
      SPComponentLoader.loadScript('https://mazdausa.sharepoint.com/sites/MCISPOTestSite/SiteAssets/Branding/js/AppMenu.js');
      //SPComponentLoader.loadScript('https://mazdausa.sharepoint.com/sites/MCISPOTestSite/SiteAssets/Branding/js/ApplicationMenuClick.js');
    });
